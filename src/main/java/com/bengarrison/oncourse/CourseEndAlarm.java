...
public class CourseEndAlarm extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        NotificationCompat.Builder assessmentNotificationBuilder = new NotificationCompat.Builder(context)
                ...
                .setContentText("You have an upcoming course end date!");
        ...
        assessmentNotificationManager.notify(2, assessmentNotificationBuilder.build());
